...
export default function MessageEntryClient() {
        ...
        <div className="flex h-full flex-col justify-between">
          <div className="space-y-7">
            <button
              ...
              onClick={() => pushWithParams('/message/generate')}
            >
            ...
            <button
              type="button"
              className="w-full cursor-pointer rounded-3xl bg-white px-7 py-8 text-left shadow-sm transition hover:bg-[#EAF8F4] hover:shadow-md"
              onClick={() => pushWithParams('/message/refine')}
            >
              <div className="flex items-center justify-between gap-6">
                <div>
                  <div className="font-semibold text-lg text-slate-900">
            ...
            <button
              type="button"
              className="w-full cursor-pointer rounded-3xl bg-white px-7 py-8 text-left shadow-sm transition hover:bg-[#EAF8F4] hover:shadow-md"
              onClick={() => pushWithParams('/message/manual')}
            >
              <div className="flex items-center justify-between gap-6">
                <div>
                  <div className="font-semibold text-lg text-slate-900">
